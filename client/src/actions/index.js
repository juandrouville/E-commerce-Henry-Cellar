...
export function postProduct(input) {
  return async dispatch => {
    try {
      ...
      alert("HEMOSIDO TIMADO -error en post product-");
    }
  };
}
...
export function editProduct(product) {
  return async dispatch => {
    try {
      ...
      alert("Caímos ante el mejor, muchacho -error en edit product-");
    }
  };
}
...
export function getUser(userData) {
  return async dispatch => {
    try {
      ...
      alert("Al menos me avisaste el error -error en get user-");
    }
  };
}
